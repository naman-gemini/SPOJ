...
void bignum_read(int dig[],int *digs)
{
    ...
    *digs=idx+1;
    ...
    {
        int mult=1,div=1000000000,carry=0;
        while(decimals--)
        {
            mult*=10;
            div/=10;
...
void bignum_intmul(int tdig[],int *tdigs,int sdig[],int sdigs,int n)
{
    ...
    {
//        long long temp=(long long)n*sdig[idx]+carry;
